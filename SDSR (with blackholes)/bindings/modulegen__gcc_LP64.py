...
def register_Ns3DsrDsrRouting_methods(root_module, cls):
    ...
    cls.add_method('Send', 
                   'void', 
                   [param('ns3::Ptr< ns3::Packet >', 'packet'), param('ns3::Ipv4Address', 'source'), param('ns3::Ipv4Address', 'destination'), param('uint8_t', 'protocol'), param('ns3::Ptr< ns3::Ipv4Route >', 'route')])
    ## dsr-routing.h (module 'dsr'): void ns3::dsr::DsrRouting::SendAck(uint16_t ackId, ns3::Ipv4Address destination, ns3::Ipv4Address realSrc, ns3::Ipv4Address realDst, uint8_t protocol, ns3::Ptr<ns3::Ipv4Route> route, std::vector<ns3::Ipv4Address> ipv4Address, unit16_t flag, ns3::Ipv4Address targetDst, ns3::Ipv4Address realSender) [member function]
    cls.add_method('SendAck', 
                   'void', 
                   [param('uint16_t', 'ackId'), param('ns3::Ipv4Address', 'destination'), param('ns3::Ipv4Address', 'realSrc'), param('ns3::Ipv4Address', 'realDst'), param('uint8_t', 'protocol'), param('ns3::Ptr< ns3::Ipv4Route >', 'route'), param('std::vector<ns3::Ipv4Address>', 'ipv4Address'), param('uint16_t', 'flag'), param('ns3::Ipv4Address', 'targetDst'), param('ns3::Ipv4Address', 'realSender')])
